 ...
 * @since 1.0.0
 */
function mdlr_block_inspector_control_jsx_example_enqueue() {
	wp_enqueue_style(
		'mdlr-block-inspector-control-jsx-example-style', // Handle.
		plugins_url( 'css/style.css', __FILE__ ), // style.css: This file styles the block on the frontend and the backend.
...
add_action( 'enqueue_block_assets', 'mdlr_block_inspector_control_jsx_example_enqueue' );
